...
declare namespace TagEvent {
    ...
    class Ritual extends Internal.TagEventJS {
    get(id: Special.RitualTag): Internal.TagWrapper
    add(tag: Special.RitualTag, ...id: Special.Ritual[]): Internal.TagWrapper
    remove(tag: Special.RitualTag, ...id: Special.Ritual[]): Internal.TagWrapper
    removeAll(tag: Special.RitualTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.Ritual[]): Internal.TagWrapper
    }
    ...
    class Definition extends Internal.TagEventJS {
    get(id: Special.DefinitionTag): Internal.TagWrapper
    add(tag: Special.DefinitionTag, ...id: Special.Definition[]): Internal.TagWrapper
    remove(tag: Special.DefinitionTag, ...id: Special.Definition[]): Internal.TagWrapper
    removeAll(tag: Special.DefinitionTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.Definition[]): Internal.TagWrapper
    }
    ...
    class Input extends Internal.TagEventJS {
    get(id: Special.InputTag): Internal.TagWrapper
    add(tag: Special.InputTag, ...id: Special.Input[]): Internal.TagWrapper
    remove(tag: Special.InputTag, ...id: Special.Input[]): Internal.TagWrapper
    removeAll(tag: Special.InputTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.Input[]): Internal.TagWrapper
    }
