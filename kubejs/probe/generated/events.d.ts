...
registry(type: "forbidden_arcanus:enhancer/effect", handler: (event: Registry.EnhancerEffect) => void):void,
registry(type: "forbidden_arcanus:enhancer/effect_condition", handler: (event: Registry.EnhancerEffectCondition) => void):void,
registry(type: "forbidden_arcanus:hephaestus_forge/input_type", handler: (event: Registry.HephaestusForgeInputType) => void):void,
registry(type: "forbidden_arcanus:item_modifier", handler: (event: Registry.ItemModifier) => void):void,
registry(type: "forbidden_arcanus:mundabitur_interaction", handler: (event: Registry.MundabiturInteraction) => void):void,
registry(type: "forbidden_arcanus:ritual_result", handler: (event: Registry.RitualResult) => void):void,
...
registry(type: "forbidden_arcanus:hephaestus_forge/ritual", handler: (event: Registry.HephaestusForgeRitual) => void):void,
...
registry(type: "forbidden_arcanus:enhancer/definition", handler: (event: Registry.EnhancerDefinition) => void):void,
registry(type: "forbidden_arcanus:hephaestus_forge/input", handler: (event: Registry.HephaestusForgeInput) => void):void,
