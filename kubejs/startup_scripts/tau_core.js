...
StartupEvents.registry('item', event => { // Register new items here event.create('example_item').displayName('Example Item')
	...
	*/
	...
	event.create('kubejs:omnipotent_alloy').texture('kubejs:item/final_ingot').displayName('High Entropy Alloy').maxStackSize(64).group('miscellaneous')
	// tools
	event.create('kubejs:final_pickaxe', 'pickaxe').tier('final_items').displayName('Particula Eversorem').texture('kubejs:item/final_pickaxe').maxStackSize(1).group('tools')
	event.create('kubejs:final_axe', 'axe').tier('final_items').displayName('Natura Exitium').texture('kubejs:item/final_axe').maxStackSize(1).group('tools')
	event.create('kubejs:final_shovel', 'shovel').tier('final_items').displayName('Terra Confractus').texture('kubejs:item/final_shovel').maxStackSize(1).group('tools')
	event.create('kubejs:final_hoe', 'hoe').tier('final_items').displayName('Agricola Manus').texture('kubejs:item/final_hoe').maxStackSize(1).group('tools')
	// weapons
	event.create('kubejs:final_sword', 'sword').tier('final_items').displayName('Corevis Ultimatum').texture('kubejs:item/final_sword').maxStackSize(1).group('combat')
	// armor
	event.create('kubejs:final_helmet', 'helmet').tier('final_armor').displayName('Conscientia Oculi').texture('kubejs:item/final_helmet').maxStackSize(1).group('combat')
	event.create('kubejs:final_chestplate', 'chestplate').tier('final_armor').displayName('Vitale Cordis').texture('kubejs:item/final_chestplate').maxStackSize(1).group('combat')
	event.create('kubejs:final_leggings', 'leggings').tier('final_armor').displayName('Universum Motus').texture('kubejs:item/final_leggings').maxStackSize(1).group('combat')
	event.create('kubejs:final_boots', 'boots').tier('final_armor').displayName('Gravitas Anchoram').texture('kubejs:item/final_boots').maxStackSize(1).group('combat')
})
